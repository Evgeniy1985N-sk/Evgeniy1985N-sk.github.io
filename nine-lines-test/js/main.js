...
/* harmony import */ var _components_home__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_components_home__WEBPACK_IMPORTED_MODULE_7__);
...
var time = 1000;
var step = 1;
var skillLabel = document.querySelectorAll(".skill__label");
var levelArrow = document.querySelector(".level__arrow");
var allSkill = 0;
var sum = 0;
var sum2 = 0;
countSkill(100);
...
function outNum(num) {
  var e = document.querySelector("#counter");
  var n = sum2;
  ...
  var interval = setInterval(function () {
    ...
    e.innerHTML = n;
    var transform = "rotate(".concat(n / 10, "deg) translate(-50%,-50%)");
...
function changeCounter() {
  ...
  for (var i = 0; i < skillLabel.length; i++) {
    _loop(i);
  }
}

function countSkill(number) {
  var skillLabelActive = document.querySelectorAll(".skill__label.is-active");
