...
function eventCard() {
  var homeCard = document.querySelectorAll(".home__card");
  var homeLike = document.querySelectorAll(".home__like");
  var homeBtn = document.querySelectorAll(".home__btn");
  var homeQuantity = document.querySelectorAll(".home__quantity");
  var homePlus = document.querySelectorAll(".home__plus");
  var homeMinus = document.querySelectorAll(".home__minus");
  var homeThing = document.querySelectorAll(".home__thing");
  var cardsArr = [];
  ...
  var _loop = function _loop(i) {
    ...
    homeBtn[i].onclick = function () {
      ...
      cardsArr[i] += 1;
      homeThing[i].innerHTML = "".concat(cardsArr[i], " \u0448\u0442.");
    };
